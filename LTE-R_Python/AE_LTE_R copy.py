...
mat = s
cipy.io.loadmat('snrCompare.mat')
...
'''
test_data,source = gD.gen_data_one_hot(M,test_size)
...
ber = BER
ser = SER
plt.plot(EbNodB_range, ser,'yo--', label='AE_BER')
...
# Open the PNG file
image_path = 'D:/NamKhanh/LTE-R_Python/output_parrot_0dBm.png'
